...
namespace BookShelfApi.Controllers
{
    ...
    public class BookmarksController : ControllerBase
    {
        ...
        public BookmarksController(BookshelfDbContext context)
        {
            _context = context;
        }
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Bookmark>> PostBookmark(BookmarkCreateDto bookmarkCreateDto)
        {
            var bookmark = new Bookmark {
                BookId = bookmarkCreateDto.BookId,
                UserId = bookmarkCreateDto.UserId,
                Note = bookmarkCreateDto.Note, 
                PageNumber = bookmarkCreateDto.PageNumber,
            };
